...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">alys-gym documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/cardhome.html" data-type="entity-link" >cardhome</a>
                            </li>
                            <li class="link">
                                <a href="components/carrusel.html" data-type="entity-link" >carrusel</a>
                            </li>
                            <li class="link">
